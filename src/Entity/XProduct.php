...
class XProduct extends FieldableEdgeEntityBase implements XProductInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $definitions['displayName']->setLabel(t('Product name'));
  ...
  public function getRatePlans() {
    if (!isset($this->ratePlans)) {
      ...
      $rate_plans = XRatePlan::loadRatePlansByXProduct($this->id());
      // Load plans for each xproduct.S
      if (!$admin_access) {
