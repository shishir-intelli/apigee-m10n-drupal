...
class PurchaseRatePlanXController extends ControllerBase implements ContainerInjectionInterface {
   ...
   * @param \Drupal\apigee_m10n\Entity\XRatePlanInterface $rate_plan
   *   The rate plan.
   *
   * @return array
   ...
   * @throws \Exception
   */
  public function purchaseForm(UserInterface $user, XRatePlanInterface $rate_plan) {
   ...
   *   The user.
   * @param \Drupal\apigee_m10n\Entity\XRatePlanInterface|null $rate_plan
   *   The rate plan.
   *
   * @return \Drupal\Core\StringTranslation\TranslatableMarkup
   *   The title.
   */
  public function title(RouteMatchInterface $route_match, UserInterface $user = NULL, XRatePlanInterface $rate_plan = NULL) {
